...
export default function LoginPage() {
  ...
  // Update field errors as user types
  ...
  const handleConfirmPasswordChange = (value: string) => {
    ...
    setFieldErrors((prev) => ({
      ...prev,
      confirmPassword: validateConfirmPassword(regPassword, value),
    }));
  };
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    const errors: Record<string, string> = {
      ...
      confirmPassword: validateConfirmPassword(regPassword, regConfirmPassword),
      role: validateRole(regSelectedRole),
    };
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                disabled={regLoading}
                className={`mt-1 w-full px-3 py-2.5 bg-secondary/50 border rounded-lg text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
